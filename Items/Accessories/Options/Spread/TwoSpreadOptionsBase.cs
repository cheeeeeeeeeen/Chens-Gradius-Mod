...
{
    public abstract class TwoSpreadOptionsBase : SpreadOptionBase
    {
        ...
        {
            Lighting.AddLight(item.Center, 1.4f, 1.4f, 1.4f);
        }
        ...
        protected override string OptionTooltip =>
          "Deploys two Options type Spread.\n" +
          "Some projectiles you create are copied by the drones.\n" +
          "The drones will follow your flight path.\n" +
          "Hold the Option Action Key to allow the options to shoot in all directions!";
